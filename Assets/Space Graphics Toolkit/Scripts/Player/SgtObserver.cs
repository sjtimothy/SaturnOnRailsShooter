...
public class SgtObserver : MonoBehaviour
{
	...
	protected virtual void OnPreCull()
	{
		...
		for (var i = SgtSkysphere.AllSkyspheres.Count - 1; i >= 0; i--)
		{
			SgtSkysphere.AllSkyspheres[i].ObserverPreCull(this);
		}
	}
	...
	protected virtual void OnPreRender()
	{
		...
		for (var i = SgtThruster.AllThrusters.Count - 1; i >= 0; i--)
		{
			SgtThruster.AllThrusters[i].SetCurrentObserver(this);
		}
	...
	protected virtual void OnPostRender()
	{
		...
		for (var i = SgtSkysphere.AllSkyspheres.Count - 1; i >= 0; i--)
		{
			SgtSkysphere.AllSkyspheres[i].ObserverPostRender(this);
		}
	}
